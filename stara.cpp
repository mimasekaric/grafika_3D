...
//float fov = 45.0f; // initial field of view angle in degrees
...
//        spacePressed = false;
//    }
//    if (glfwGetKey(window, GLFW_KEY_A) == GLFW_PRESS) cameraAngle -= 0.01f;
//    if (glfwGetKey(window, GLFW_KEY_D) == GLFW_PRESS) cameraAngle += 0.01f;
//    if (speed < 0) speed = 0;
//
...
//    float vertices[] = {
//        -0.1f,-0.1f,-0.1f, 1,0,0,1,
//         0.1f,-0.1f,-0.1f, 1,0,0,1,
//         0.1f, 0.1f,-0.1f, 1,0,0,1,
//        -0.1f, 0.1f,-0.1f, 1,0,0,1,
//        -0.1f,-0.1f, 0.1f, 0,1,0,1,
//         0.1f,-0.1f, 0.1f, 0,1,0,1,
//         0.1f, 0.1f, 0.1f, 0,1,0,1,
//        -0.1f, 0.1f, 0.1f, 0,1,0,1,
//    };
...
//    glFrontFace(GL_CCW);  // Set front face winding order (counter-clockwise)
//
//    // Callback za scroll
...
//        if (!paused) {
//            lastTime = glfwGetTime() * speed;  // Ažuriramo samo ako nije pauzirano
//        }
...
//
//        // Calculate camera position that follows the last cube
//        glm::vec3 cameraPos = lastCubePos + glm::vec3(cameraOffsetX, 0.2f, cameraOffsetZ);
//
//        // Create view matrix that looks at the last cube
//        glm::mat4 view = glm::lookAt(
//            cameraPos,           // pozicija kamere
